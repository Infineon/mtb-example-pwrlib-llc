...
void HW_IFACE_Init()
{
    ...
    hw_fcn.Init = MCU_Init;
    hw_fcn.EnterCriticalSection = MCU_EnterCriticalSection;
    hw_fcn.ExitCriticalSection = MCU_ExitCriticalSection;
    hw_fcn.GateDriverEnterHighZ = MCU_GateDriverEnterHighZ;
    hw_fcn.GateDriverExitHighZ = MCU_GateDriverExitHighZ;
    hw_fcn.SyncRecEnableDisable = MCU_SyncRecEn;
    hw_fcn.FaultResetEngage = MCU_FaultResetEngage;
    hw_fcn.FaultResetRelease = MCU_FaultResetRelease;
    hw_fcn.StartPeripherals = MCU_StartPeripherals;
    hw_fcn.StopPeripherals = MCU_StopPeripherals;
    hw_fcn.FlashRead = MCU_FlashReadParams;
    hw_fcn.FlashWrite = MCU_FlashWriteParams;
}
